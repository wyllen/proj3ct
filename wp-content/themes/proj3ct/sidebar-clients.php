...
if ( $query->have_posts() ) {
	while ( $query->have_posts() ) {
		$query->the_post();
		echo '<li class="item-list-wrapper" data-search="' . strtolower ( get_the_title() ) . '"><a href="#detail" class="item-list-link" data-detail-type="client" data-detail-id="'. get_the_ID().'" >' . get_the_title() . '</a><span class="item-list-delete item-delete"></span></li>';
	}
} else {
